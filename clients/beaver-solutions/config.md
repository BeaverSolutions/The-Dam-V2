# Beaver Solutions — Agent Config

_This is the internal Beaver Solutions account. Use this as the reference config._
...
**Tone:** Warm, direct, peer-to-peer — like a smart friend who knows sales, not a salesperson
**Language style:** Malaysian English is fine. Conversational. No stiff corporate language.
...
low-hanging fruit, circle back, touch base, move the needle, best-in-class
...
- Reference the founder-doing-all-sales pain directly — it resonates immediately
- Keep it founder-to-founder: "I built this because I had the same problem"
...
**AgentMail inbox:** Configured (see Railway env vars)
**Hunter.io:** Configured
**Apollo.io:** Configured
**INTERNAL_API_KEY:** Set on Railway
...
- [x] Hunter.io key added
- [x] Apollo.io key added
- [ ] Test campaign run (3 leads, 3 messages)
- [ ] Ranger passing ≥ 80% first time
- [ ] First autonomous kickoff at 8:30am verified
